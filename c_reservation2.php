<?php
   ...
   $sql2 = mysqli_query($conn,"select * from reservation where re_id = '$rs_id'");
    ...
    <div class="col-sm-12">
      <?php
        if ($ds >= 2) {
         ...
         $sql3 = mysqli_query($conn,"DELETE FROM book WHERE cs_id = '$cus_id' AND re_id = '$rs_id'"); 
         
         if ($sql3) {
         
           $sql4 = mysqli_query($conn,"DELETE FROM reserve WHERE re_id = '$rs_id'");

           $sql5 = mysqli_query($conn,"DELETE FROM reservation WHERE re_id = '$rs_id'");
