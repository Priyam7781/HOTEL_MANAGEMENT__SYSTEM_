  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      ...
      <?php
        ...
        $rs=mysqli_query($conn,"select * from customer where email='$mail'");
      ...
      <?php
          ...
          $res = mysqli_query($conn,"insert into gen2_number set name = 'Asif'");
          $sql = mysqli_query($conn,"select * from gen2_number");
          while ($row=mysqli_fetch_array($sql)) {
            $x = $row[0];
          }

          $sql2 = mysqli_query($conn,"select concat('CS-', id) as id from gen2_number where id = '$x'");  
          $row2 = mysqli_fetch_row($sql2);
          $id_cus = $row2[0];  
          // end of generating reservation number

          $sql3=mysqli_query($conn,"INSERT INTO customer (cs_id, firstName, lastName, email, password, phone) VALUES ('$id_cus', '$fname', '$lname', '$mail', '$password1', '$cell')") or die(mysql_error()); 
