...
<?php
   $rm = mysqli_query($conn,"SELECT room_no, qty, price FROM rooms WHERE type='$rm_t'");
   ...
   $rs = mysqli_query($conn,"SELECT rv.res_room FROM reserve rv, reservation rn WHERE c_in<='$ck_in' and c_out>='$ck_out' and rv.room_no='$x' and rv.re_id=rn.re_id"); 
