<?php
   ...
   $res = mysqli_query($conn,"insert into gen_number set name = 'Asif'");
   $sql = mysqli_query($conn,"select * from gen_number");
   while ($row=mysqli_fetch_array($sql)) {
     $x = $row[0];
   }

   $sql2 = mysqli_query($conn,"select concat('RE-', id) as id from gen_number where id = '$x'");  
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      <?php
         ...
         $sql3 = mysqli_query($conn,"INSERT INTO reservation (re_id, c_in, c_out, re_date, stay) VALUES ('$id_res', '$in_date', '$out_date', '$t_date', '$_SESSION[night]')"); 
         
         $sql4 = mysqli_query($conn,"INSERT INTO book (cs_id, re_id) VALUES ('$row1[0]', '$id_res')");

         $sql5 = mysqli_query($conn,"INSERT INTO reserve (re_id, room_no, res_room, checked) VALUES ('$id_res', '$_SESSION[rm_no]', '$_SESSION[no_of_room]', '0')");
